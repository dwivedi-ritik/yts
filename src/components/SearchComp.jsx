        ...
        return (
            <React.Fragment>
                <div className="mt-4 flex justify-center sm:mt-15">
                    <input className="text-gray-700 shadow-sm rounded-l-full px-3 py-2 h-10  focus:outline-none" id="search" type="text" value={usrInp} onChange={this.getInpVal} placeholder="Search Movie"></input>
                    <div className="">
                        <button onClick={this.searchMovie} className="bg-yellow-300 text-white h-10 px-2 rounded-r-full hover:bg-yellow-400 focus:outline-none">
                            Search
                        </button>
                    </div>
                </div>
